...
export default function SpotifyItem({ name, imageUrl, artist, album }: SpotifyItemProps) {
	return (
		<div className="flex items-center space-x-4 p-2 rounded-md transition-all duration-300 hover:bg-white/40">
